              ...
              <Button
                ...
                className={
                  category === selectedCategory
                    ? "bg-[#0077B6] hover:bg-[#0077B6]/90 text-white shadow-lg"
                    : "border-[#0077B6]/30 hover:bg-[#0077B6]/10 hover:border-[#0077B6]/50 text-[#0077B6] transition-all duration-300"
                }
              >
                {category}
              </Button>
      ...
      {filteredPosts.length === 0 && (
        <section className="py-32 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="w-24 h-24 rounded-full bg-[#0077B6]/10 flex items-center justify-center mx-auto mb-8">
              <TrendingUp className="h-12 w-12 text-[#0077B6]" />
            </div>
            <h2 className="text-3xl font-bold mb-4 text-[#0077B6]">Aucun article trouvé</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Aucun article n'est disponible pour la catégorie "{selectedCategory}". 
              Essayez une autre catégorie ou revenez à "Tous".
            </p>
            <Button 
              onClick={() => setSelectedCategory("Tous")}
              className="bg-[#0077B6] hover:bg-[#0077B6]/90 text-white"
            >
